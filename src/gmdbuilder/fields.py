...
ID_TO_TYPEDDICT: dict[int, type[ObjectType]] = {
    ...
    tid.EnterPreset.CHAOTIC: td.EnterPresetType,
    ...
    tid.EnterPreset.NO_FADE: td.EnterPresetType,
    ...
    obj_id.Portal.Teleport.EXIT: td.TeleportType,
    ...
    tid.Enter.ROTATE: td.EffectType,
    tid.Enter.SCALE: td.EffectType,
    tid.Enter.FADE: td.EffectType,
    tid.Enter.TINT: td.EffectType,
    tid.TELEPORT: td.TeleportType,
    tid.Enter.STOP: td.EffectType,
    tid.Area.STOP: td.EffectType,
    obj_id.Orb.TELEPORT: td.TeleportType,
