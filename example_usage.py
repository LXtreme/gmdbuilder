...
# block = {'a1': 1} # required for putting into level.object and related methods

# all_objects.delete_where(block, limit=4) # deletes 4 match of block
all_objects.delete_where(lambda obj: obj[obj_prop.ID] == obj_id.Trigger.MOVE) # deletes all matches of block
...
all_objects.extend([movetrig, obj])

b = new_obj(obj_id.Trigger.MOVE)
