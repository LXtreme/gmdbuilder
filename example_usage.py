...
from gmdbuilder.object_typeddict import CountType, MoveType
...
from gmdbuilder.templates import Trigger
...
obj[ObjProp.X] = 0
obj[ObjProp.Y] = 0
obj[ObjProp.GROUPS] = { 67 }
obj[ObjProp.Trigger.Count.ACTIVATE_GROUP] = True
# Add a block
...
def move_to_target(target:int, location:int):
    level.objects.append(Trigger.move_to_target(
        x=0, y=0,
        target=target,
        location=location,
        duration=2,
